# 🧬 Corona Counter
Corona Counter keeps track of all statistics about the coronavirus.
...
### :star: Features
- Track all numbers
- Shows stats of specific countries

### :rocket: Getting Started
If you have git installed: 
```sh
$ git clone https://github.com/rohitjethoe/coronacounter.git
```
